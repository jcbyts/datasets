...
class ColorCloud(Dataset):
    
    def __init__(self,
        dirname='None',
        sess_list:list=None,
        num_lags:int=12,
        fixations_only:bool=True,
        
        include_MUs:bool=True,
        eyepos:list= None,
        verbose=False,
        download=False,
        downsample_t:int=1,
        ...
        # Conditions
        assert dirname is not None, "Must provide 'dirname'"
        ...
        self.fnames = sess_list  # sess_list is the list of filenames for this dataset (for now) 
        ...
        self.fhandles = {fname: h5py.File(os.path.join(dirname, fname), 'r') for fname in self.fnames}
